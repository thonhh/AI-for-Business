...
namespace Tri_tue_nhan_tao
{
	...
	public class FormKhoidau : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.menuDothiVH.Click += new System.EventHandler(this.menuDothiVH_Click);
			// 
			// menuItem8
			// 
			...
			this.pictureBox.Size = new System.Drawing.Size(578, 387);
		...
		private void FormMain_Load(object sender, System.EventArgs e)
		{
			...
			pictureBox.Image= Image.FromFile(path+"\\Images\\Canon.bmp",false);
			CreateMyStatusBar();
		}
		...
		{
			FormDothi form1=new FormDothi();
			form1.ShowDialog();
		}

		private void menuThoat_Click(object sender, System.EventArgs e)
		{
			this.Close();
		}

		private void menuTacgia_Click(object sender, System.EventArgs e)
		{
			FormTacgia form1=new FormTacgia();
			form1.ShowDialog();
		}

		private void menuDothiVH_Click(object sender, System.EventArgs e)
		{
			FormDo_thi_VH obj=new FormDo_thi_VH();
			obj.ShowDialog();
		}
	}
}
