...
namespace Tri_tue_nhan_tao
{
	...
	/// </summary>
	public class FormHueristic : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// richTextBox_Dinh
			// 
			this.richTextBox_Dinh.Location = new System.Drawing.Point(32, 56);
			this.richTextBox_Dinh.Name = "richTextBox_Dinh";
			this.richTextBox_Dinh.Size = new System.Drawing.Size(32, 272);
			this.richTextBox_Dinh.TabIndex = 0;
			this.richTextBox_Dinh.Text = "";
			// 
			// richTextBox_H
			// 
			this.richTextBox_H.Location = new System.Drawing.Point(64, 56);
			...
			this.label1.Text = "Bảng giá trị Hueristic";
			// 
			// label2
			// 
		...
		private void FormHueristic_Load(object sender, System.EventArgs e)
		{
			for (int i=1;i<=Class_MienDoThi.dinh_Max;i++)
				if (Class_MienDoThi.Kiem_tra_dinh_thuoc_DThi(i))
				{
					...
					richTextBox_H.Text+=Class_MienDoThi.Get_Hueristic(i).ToString()+"\n";
				}
		}
	}
}
