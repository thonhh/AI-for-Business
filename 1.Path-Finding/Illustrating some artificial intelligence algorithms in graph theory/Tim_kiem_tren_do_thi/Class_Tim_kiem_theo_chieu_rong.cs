...
{
	/// <summary>
	/// Summary description for Class_Tim_kiem_theo_chieu_rong.
	/// </summary>
	public class Class_Tim_kiem_theo_chieu_rong
	{
		...
		private int[] truoc;
		private int n0,n1;
		public Class_Tim_kiem_theo_chieu_rong()
		{
			//
		...
		public void Tim_kiem_theo_chieu_rong()
		{
			Khoi_tao();
			...
			if (tim_duoc)
			{
				richTextBox_Kq.Text="Đường đi theo BrFS : ";
				inkq(n1);
			}
			else
